...
for key,value in Companies.items():
    ...
    print("From {0} {1} people have bought stuff on discount and paid in cash, also assistants got {2} serving of coffee on credit".format(Names,cashCount,creditCount))